...
public class SubMenuActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lbl_titulo                 = findViewById(R.id.lbl_titulox);
        myRecyclerView             = findViewById(R.id.myRecyclerView3);
...
/*        btn_menu.setOnClickListener(new View.OnClickListener() {
    ...
    void setAdapter()
    {
        ...
        saltarin.setOnClickListener(new View.OnClickListener() {
            ...
            {
                veritran();
                if (!((MyApplication) getApplicationContext()).getAnimatesubmenu())
                {
                ...
                else
                {
                    ...
                    mov.performClick();
                    ((MyApplication) getApplicationContext()).setAnimatesubmenu(false);
                }
            }});
